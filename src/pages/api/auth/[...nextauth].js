...
export const authOptions = {
    // Comment out the adapter for now since we're using your existing users table
                ...
                try {
                    ...
                    if (result.rows.length === 0) {
                        ...
                        await pool.query(
                            ...
                            [user.name, user.email, username, 'google_oauth'] // placeholder password for OAuth users
                        )
                    }
